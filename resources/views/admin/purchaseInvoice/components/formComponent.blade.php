...
$input = "date";
inputForm('Date ( تاريخ الفاتورة )',['type' => 'date', 'class' => 'form-control','name' => $input ,'placeholder' => 'Date ( التفاصيل ) ','value' => isset($row->$input) ? $row->$input : date('Y-m-d')] , isset($errors->toArray()[$input]) ? $errors->toArray()[$input] : [] );
...
<div id="AllProducts">
<div id="product0" style="margin-top: 10px;height: 150px;border: 1px solid #BFBFBF; background-color: white;box-shadow: 10px 10px 5px #aaaaaa; ">
...
<div class='form-group col-md-2'>
    <label style="margin-left: 15px;color:red;"> Pay/P ( سعر الشراء ) </label>
    <div class='col-sm-12'>
...
<div class='form-group col-md-2'>
    <label style="margin-left: 15px;color:red;"> Total Price ( الاجمالي ) </label>
    <div class='col-sm-12'>
