...
Route::namespace('Admin')->prefix('backend')->middleware('auth')->group(function(){
    ...
    Route::get('casher','Dashboard@casher')->name('dashboard.casher');
    ...
    Route::get('categories/{id}/income','Categories@income')->name('category.income');
    ...
    // OutComes Routs
    Route::resource('outcomes','OutComes');
    Route::post('outcomes/print','OutComes@print')->name('outcomes.print');
